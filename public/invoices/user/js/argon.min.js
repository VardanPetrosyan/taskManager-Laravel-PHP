...
var BarStackedChart = function () {
    ...
    t.length && (e = t, a = new Chart(e, {
        ...
        options: {
            scales: {
                yAxes: [{
                    gridLines: {color: Charts.colors.gray[200], zeroLineColor: Charts.colors.gray[200]},
                    ticks: {}
                }]
            }
        },
    ...
    t.length && (e = t, a = new Chart(e, {
        ...
        options: {
            scales: {
                yAxes: [{
                    gridLines: {color: Charts.colors.gray[700], zeroLineColor: Charts.colors.gray[700]},
                    ticks: {}
                }]
            }
        },
